...
public class Crypto {
    private static final String defaultKey = "82413f56f78e2f5d23a2b6d3ac01539efc63b82b8b6d4a3785bb454fcba40d05";
    ...
    public static void main(String[] args) {
        ...
        String strToEncrypt = "admin"+timeMilis;//put text to encrypt in here
